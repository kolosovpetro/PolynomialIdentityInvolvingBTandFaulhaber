...
\begin{document}
    ...
    \section{Binomial power sums}\label{sec:binomial-power-sums}
    \input{binomial_power_sums}


    \section{Faulhaber's formulae}\label{sec:faulhaber's-formulae}
    \input{faulhabers_formulae}
%
%

\begin{examp}
    ...
    $3 \leq d < 5$.
    The value of $\coeffA{5}{2}$ coefficient is non-zero and calculated as
    \begin{equation*}
        \begin{split}
            \coeffA{5}{2}
        ...
        \end{split}
    \end{equation*}
    The value of $\coeffA{5}{1}$ coefficient is non-zero and calculated as
    \begin{equation*}
        \begin{split}
            \coeffA{5}{1}
        ...
        \end{split}
    \end{equation*}
    Finally the $\coeffA{5}{0}$ coefficient is
    \begin{equation*}
        \begin{split}
            \coeffA{5}{0}

...
\begin{document}
    ...
    \input{coefficients_recursion_examples}
    ...
    \input{coefficients_recursion_derivation_example5}
%
%
%    \section{Coefficients derivation}\label{sec:coefficients-derivation}
%    \input{sections/coefficients_derivation}
%
%
